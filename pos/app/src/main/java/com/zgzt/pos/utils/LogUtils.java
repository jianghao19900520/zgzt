...
/**
 * Created by zixing on 2017/12/20.
 * <p>
 * desc ：
 */
    ...
    public static class Config {
        private Config() {
            ...
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                    && BaseApplication.mContext.getExternalCacheDir() != null)
                sDefaultDir = BaseApplication.mContext.getExternalCacheDir() + FILE_SEP + "log" + FILE_SEP;
            else {
                sDefaultDir = BaseApplication.mContext.getCacheDir() + FILE_SEP + "log" + FILE_SEP;
            }
        }
